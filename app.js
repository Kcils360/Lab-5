...
var ansString = testArray + ' was passed in as an array of numbers, and ' + arraySum2[0] + ' is their sum.';
...
function multiplyArray(testArray){ //eslint-disable-line
  var arrayProd1 = multiply(testArray[0],testArray[1]);
  var arrayProd2 = multiply(testArray[2],arrayProd1[0]);
  var ansString = 'The numbers ' + testArray + ' have a product of ' + arrayProd2[0] + '.';
  return [arrayProd2[0],ansString];
}
...
document.getElementById('sumAnd').innerHTML = sumAndMultiply(4,7,9)[2];
document.getElementById('andMultiply').innerHTML = sumAndMultiply(4,7,9)[3];
